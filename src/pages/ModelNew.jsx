				...
				<dl className="divide-y divide-gray-100">
					<div className="px-4 py-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-0">
						...
						<dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-3 sm:mt-0">
							<p>
								Use this form to propose a pre-trained model for inclusion in
								the catalog.
							</p>
					...
					<div className="px-4 py-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-0">
						...
						<dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-3 sm:mt-0">
							<div className="mt-1 max-w-2xl text-sm leading-6 text-gray-500 prose">
								<ul className="">
									<li>
										...
										<ul>
											<li>
												...
												button below and choosing "Create an account" when
												prompted for your credentials
											</li>
										</ul>
									</li>
									<li>
										Your model is publically available from a source repository
										or on a package server
										<ul>
											<li>
												The Scivision catalog does not host your model, just a
												link to it, so it must be publically accessible
												somewhere
											</li>
											<li>
												For example, your model may be published on PyPI or have
												its source code available on GitHub, Gitlab or elsewhere
											</li>
										</ul>
									</li>
									<li>
										Your model includes everything needed to run it, including
										any weights and parameters
										<ul>
											<li>
												Not <em>just</em> model weights
											</li>
											<li>
												Note: Models that require training or fitting to data
												before running can be suggested, but answer 'No' to{" "}
												<em>Model runs with Scivision?</em> below
											</li>
										</ul>
									</li>
									<li>
										Your model is set up as a Python package, and is installable
										with pip
										<ul>
											<li>
									...
									<li>
										...
										<ul>
											<li>
												This has the benefit of allowing programmatic access to
												the model through Scivision.Py
											</li>
											<li>
												{" "}
			...
			<div className="">
				{!gh_logged_in ? (
					...
					<CatalogEntryForm
						...
						thumbnailData={sessionStorage.getItem("new-model-thumbnail/jpeg")}
