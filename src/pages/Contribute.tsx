...
export default function Contribute() {
	return (
		<>
			...
			<div className="divide-y divide-gray-200 overflow-hidden rounded-lg bg-gray-200 shadow sm:grid sm:grid-cols-1 md:grid-cols-3 sm:gap-px sm:divide-y-0">
				{actions.map((action, actionIdx) => (
					...
					>
						<div>
							<span className="inline-flex rounded-lg p-3 ring-4 ring-white text-white bg-scipurple">
